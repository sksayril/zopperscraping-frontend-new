...
import { apiService, JioMartScrapeRequest, JioMartScrapeResponse, JioMartProductData } from '../services/api';
import JioMartProductDisplay from './JioMartProductDisplay';
import { validateJioMartUrl, formatPrice, formatDate, generateImagePlaceholder } from '../utils/helpers';
...
export default function JioMartScraper() {
  ...
  const handleScrape = async () => {
    if (!url.trim()) {
      setError('Please enter a valid JioMart product URL');
      return;
    }

    // Basic URL validation
    if (!validateJioMartUrl(url)) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">JioMart Product Scraper</h2>
        </div>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <input
                ...
                placeholder="https://www.jiomart.com/p/groceries/product-name/product-id"
