...
import { apiService, FlipkartScrapeRequest, FlipkartScrapeResponse, FlipkartProductData } from '../services/api';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Flipkart Product Scraper</h2>
        </div>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <input
                ...
                placeholder="https://www.flipkart.com/product-name/p/itm123456789..."
            ...
            <p className="mt-2 text-sm text-gray-500">
              Enter a valid Flipkart product URL to scrape product details, images, and specifications.
            </p>
          </div>
